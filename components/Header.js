            ...
            cursor-pointer">
                ...
                <div className="max-w-xs">
                    <div className=" relative mt-1 p-3 rounded-md">
                        ...
                        border-gray-300 focus:ring-black focus:border-black rounded-md" placeholder="Search"
                        />
                    </div>
                </div>
                {/* right icons */}
                <div className="flex items-center justify-end space-x-5">
                    ...
                    <MenuIcon className="w-10 h-7 md:hidden"/>
                    ...
                    <div className="relative navBtn">
                            ...
                            flex items-center justify-center animate-pulse text-white pb-0.5 "
                        >5</div>
                    </div>
